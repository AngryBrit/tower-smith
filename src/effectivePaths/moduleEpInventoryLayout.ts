...
/** Sidebar Assist Level row (column D) on compact Inventory — v6.1.2 absolute row (substat band + 1). */
...
export const MODULE_EP_INVENTORY_SECTIONS: Record<WorkshopAssistModuleSlot, ModuleEpInventorySection> = {
  cannon: {
    ...
    substatStartRow: 3,
    modules: [
      { moduleId: 'havocBringer', baseCol: 5 },
      { moduleId: 'deathPenalty', baseCol: 10 },
      { moduleId: 'beingAnnihilator', baseCol: 15 },
      { moduleId: 'astralDeliverance', baseCol: 20 },
  ...
  generator: {
    ...
    modules: [
      ...
      { moduleId: 'pulsarHarvester', baseCol: 10 },
      { moduleId: 'galaxyCompressor', baseCol: 15 },
      { moduleId: 'singularityHarness', baseCol: 20 },

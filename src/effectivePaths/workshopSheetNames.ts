...
const WORKSHOP_ENHANCE_SHEET_ALIASES: Readonly<Record<string, WorkshopEpEnhanceKey>> = {
  ...
  'Damage/Meter +': 'enhanceDamagePerMeterLevel',
  'Unlock Rend+': 'enhanceRendArmorLevel',
  'Unlock Rend +': 'enhanceRendArmorLevel',
  'Unlock CF+': 'enhanceCritFactorLevel',
  'Unlock CF +': 'enhanceCritFactorLevel',
  'Unlock DPM+': 'enhanceDamagePerMeterLevel',
  'Unlock DPM +': 'enhanceDamagePerMeterLevel',
  'Unlock SCM +': 'enhanceSuperCritMultLevel',
  'Unlock ASPD +': 'enhanceAttackSpeedLevel',
  'Unlock Regen+': 'enhanceHealthRegenLevel',
  'Unlock Regen +': 'enhanceHealthRegenLevel',
  'Unlock DABS+': 'enhanceDefenseAbsoluteLevel',
  'Unlock DABS +': 'enhanceDefenseAbsoluteLevel',
  'Unlock LMD+': 'enhanceLandMineDamageLevel',
  'Unlock LMD +': 'enhanceLandMineDamageLevel',
  'Unlock WH+': 'enhanceWallHealthLevel',
  'Unlock WH +': 'enhanceWallHealthLevel',
  'Unlock Orb Size +': 'enhanceOrbSizeLevel',
  'Unlock Coin+': 'enhanceCoinBonusLevel',
  'Unlock Coin +': 'enhanceCoinBonusLevel',
  'Unlock CB+': 'enhanceCoinBonusLevel',
  'Unlock CB +': 'enhanceCoinBonusLevel',
  'Unlock CKB+': 'enhanceCellsKillBonusLevel',
  'Unlock CKB +': 'enhanceCellsKillBonusLevel',
  'Unlock Cells+': 'enhanceCellsKillBonusLevel',
  'Unlock Cells +': 'enhanceCellsKillBonusLevel',
  'Unlock FU+': 'enhanceFreeUpgradesLevel',
  'Unlock FU +': 'enhanceFreeUpgradesLevel',
  'Unlock RP+': 'enhanceRecoveryPackageLevel',
  'Unlock RP +': 'enhanceRecoveryPackageLevel',
  'Unlock ELS+': 'enhanceEnemyLevelSkipLevel',
  'Unlock ELS +': 'enhanceEnemyLevelSkipLevel',

export const STRINGS_DE = {
  ...
  vault_tab_harmony: 'Harmonie',
  vault_tab_power: 'Kraft',
  vault_keys_spent: '{n} Schlüssel ausgegeben',
  vault_unlock: 'Freischalten',
  vault_owned: 'Erhalten',
  vault_remove: 'Entfernen',
  vault_locked: 'Gesperrt',
  vault_max: 'Max',
  vault_requires_parent: 'Schalte zuerst das verbundene Upgrade frei',
  vault_tier_of: 'Stufe {n}/{max}',
  vault_upgrade_to_tier: 'Stufe {n}',
  vault_tier_locked_t2: 'Schalte zuerst Stufe x2 frei',
  vault_tier_locked_t3: 'Schalte zuerst Stufe x3 frei',
  vault_tier2_req: 'Benötigt {n} Stufe-1-Freischaltungen ({c}/{n})',
  vault_tier3_req: 'Benötigt {a} Stufe 1 ({c1}/{a}) und {b} Stufe 2 ({c2}/{b})',
  vault_reset: 'Tresor zurücksetzen',
  vault_reset_aria: 'Alle Tresor-Upgrades zurücksetzen',
  vault_reset_confirm_title: 'Tresor zurücksetzen?',
  vault_reset_confirm_body: 'Alle gekauften Kraft- und Harmonie-Upgrades entfernen.',
  vault_reset_confirm: 'Tresor zurücksetzen',
  ...
  app_tools_full_reset_aria:
    'Alle in diesem Browser gespeicherten TowerSmith-Daten löschen: Labor, Werkstatt, Builds, Themes, Profil und Einstellungen',
  app_tools_full_reset_hint:
    'Löscht alle lokal gespeicherten Daten dieser App und bei Anmeldung auch Profil und Cloud-Backup im Konto, dann wird die Seite neu geladen. Exportiere oder kopiere zuerst einen Freigabelink, wenn du deine Daten behalten willst.',
  app_tools_full_reset_confirm_title: 'Alle gespeicherten Daten zurücksetzen?',
  app_tools_full_reset_confirm_body:
    'Entfernt Labor-Stufen, gespeicherte Builds, Werkstatt-Upgrades, Karten, Module, Relikte, Wächter-Chips, Themes, Sprache, Anzeigename, Gilde, Effective-Paths-Tabelle und andere TowerSmith-Einstellungen in diesem Browser. Bei Anmeldung werden auch Profil und Cloud-Backup im Konto gelöscht. Die Seite wird mit Werkseinstellungen neu geladen. Exportiere oder kopiere zuerst einen Freigabelink, wenn du deine Daten behalten willst.',
  ...
  ws_cards_rarity_common: 'Gewöhnlich',
  ws_cards_rarity_rare: 'Selten',
  ws_cards_rarity_epic: 'Episch',
  ws_cards_detail_close_aria: 'Kartendetails schließen',
  ws_cards_detail_equip: 'Ausrüsten',
  ws_cards_detail_unequip: 'Ablegen',
  ws_cards_detail_equip_aria: '{{card}} ausrüsten',
  ws_cards_detail_unequip_aria: '{{card}} ablegen',
  ws_cards_detail_max_level: 'Max. Stufe',
  ws_cards_detail_level: 'St. {{level}}',
  ws_cards_detail_mastery_aria: 'Kartenmeisterschaft',
  ...
  ws_modules_inventory_title: 'INVENTAR',
  ws_modules_inventory_aria: 'Chassis-Modul-Inventar',
  ws_modules_inventory_filter_aria: 'Module nach Chassis filtern',
  ...
  ws_modules_module_owned_copies_aria: '{{module}} ({{count}} Kopien)',
  ws_modules_inventory_copy_badge: '×{{count}}',
  ws_modules_inventory_copies_title: 'Besessene Kopien ({{count}})',
  ws_modules_inventory_copy_line: '{{tier}} St. {{level}}',
  ...
  ep_export_picker_failed:
    'Das Google-Dateiauswahlfenster konnte nicht geöffnet werden. Chrome oder Firefox nutzen, Pop-ups für diese Seite erlauben und erneut versuchen.',
  ...
  sr_reset_cards_aria: 'Kartensterne, Loadouts, Ausstattungs-Slots und Kartenmeisterschaft zurücksetzen',
  sr_reset_cards_confirm_title: 'Nur Karten zurücksetzen?',
  sr_reset_cards_confirm_body:
    'Löscht Kartensterne, alle Preset-Loadouts, Ausstattungs-Slots und Kartenmeisterschaft-Freischaltungen.',

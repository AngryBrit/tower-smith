export const STRINGS_ES = {
  ...
  vault_tab_harmony: 'Armonía',
  vault_tab_power: 'Poder',
  vault_keys_spent: '{n} llaves gastadas',
  vault_unlock: 'Desbloquear',
  vault_owned: 'Obtenido',
  vault_remove: 'Quitar',
  vault_locked: 'Bloqueado',
  vault_max: 'Máx',
  vault_requires_parent: 'Desbloquea primero la mejora conectada',
  vault_tier_of: 'Nivel {n}/{max}',
  vault_upgrade_to_tier: 'Nivel {n}',
  vault_tier_locked_t2: 'Desbloquea primero el Nivel x2',
  vault_tier_locked_t3: 'Desbloquea primero el Nivel x3',
  vault_tier2_req: 'Requiere {n} desbloqueos de Nivel 1 ({c}/{n})',
  vault_tier3_req: 'Requiere {a} Nivel 1 ({c1}/{a}) y {b} Nivel 2 ({c2}/{b})',
  vault_reset: 'Restablecer bóveda',
  vault_reset_aria: 'Restablecer todas las mejoras de la bóveda',
  vault_reset_confirm_title: '¿Restablecer bóveda?',
  vault_reset_confirm_body: 'Quitar todas las mejoras de Poder y Armonía compradas.',
  vault_reset_confirm: 'Restablecer bóveda',
  ...
  guardians_chip_bits_invested_title: 'Bits totales invertidos en esta vía',
  ...
  ws_cards_detail_equip: 'Equipar',
  ws_cards_detail_unequip: 'Quitar',
  ws_cards_detail_equip_aria: 'Equipar {{card}}',
  ws_cards_detail_unequip_aria: 'Quitar {{card}}',

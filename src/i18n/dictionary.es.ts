...
export const STRINGS_ES = {
  ...
  profile_guild_label: 'Gremio',
  profile_guild_hint:
    'Opcional. 1–40 caracteres. Rellena el gremio al publicar un build; puedes cambiarlo en cada publicación.',
  profile_guild_save_btn: 'Guardar gremio',
  ...
  gallery_field_guild: 'Guild (opcional)',
  gallery_field_guild_placeholder: 'Nombre de guild',

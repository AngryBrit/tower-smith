...
export const STRINGS_EN = {
  ...
  guardians_respec_confirm_body: 'Unequip all guardian chips from your loadout.',
  ...
  ep_sync_intro:
    'Load linked workbooks from your IDS Master (set in Settings), then import from or export to each child workbook.',

...
export const STRINGS_EN = {
  ...
  profile_guild_label: 'Guild',
  profile_guild_hint:
    'Optional. 1–40 characters. Prefills the guild field when you publish a build; you can change it per build.',
  profile_guild_save_btn: 'Save guild',

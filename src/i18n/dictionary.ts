...
export const STRINGS_EN = {
  ...
  vault_tab_harmony: 'Harmony',
  vault_tab_power: 'Power',
  vault_keys_spent: '{n} keys spent',
  vault_unlock: 'Unlock',
  vault_owned: 'Owned',
  vault_remove: 'Remove',
  vault_locked: 'Locked',
  vault_max: 'Max',
  vault_requires_parent: 'Unlock the connected upgrade first',
  vault_tier_of: 'Tier {n}/{max}',
  vault_upgrade_to_tier: 'Tier {n}',
  vault_tier_locked_t2: 'Unlock Tier x2 first',
  vault_tier_locked_t3: 'Unlock Tier x3 first',
  vault_tier2_req: 'Requires {n} Tier 1 unlocks ({c}/{n})',
  vault_tier3_req: 'Requires {a} Tier 1 ({c1}/{a}) & {b} Tier 2 ({c2}/{b}) unlocks',
  vault_reset: 'Reset Vault',
  vault_reset_aria: 'Reset all Vault upgrades',
  vault_reset_confirm_title: 'Reset Vault?',
  vault_reset_confirm_body: 'Remove all purchased Power and Harmony upgrades.',
  vault_reset_confirm: 'Reset Vault',
  vault_name_ultimate_damage: 'Ultimate Damage',
  vault_desc_ultimate_damage: '{v} boost to ultimate weapon damage',
  vault_name_bot_range: 'Bot Range',
  vault_desc_bot_range: '{v} increase to bot range',
  vault_name_damage_meter: 'Damage / Meter',
  vault_desc_damage_meter: '{v} more damage per meter',
  vault_name_critical_chance: 'Critical Chance',
  vault_desc_critical_chance: '{v} increase to critical chance',
  vault_name_damage: 'Damage',
  vault_desc_damage: '{v} increase to damage',
  vault_name_super_crit_chance: 'Super Crit Chance',
  vault_desc_super_crit_chance: '{v} increase to super crit chance',
  vault_name_rend_armor_mult: 'Rend Armor Mult',
  vault_desc_rend_armor_mult: '{v} increase to rend armor multiplier',
  vault_name_critical_factor: 'Critical Factor',
  vault_desc_critical_factor: '{v} increase to critical factor',
  vault_name_attack_speed: 'Attack Speed',
  vault_desc_attack_speed: '{v} increase to attack speed',
  vault_name_super_crit_mult: 'Super Crit Mult',
  vault_desc_super_crit_mult: '{v} increase to super crit multiplier',
  vault_name_rend_armor_chance: 'Rend Armor Chance',
  vault_desc_rend_armor_chance: '{v} increase to rend armor chance',
  vault_name_rapid_fire_chance: 'Rapid Fire Chance',
  vault_desc_rapid_fire_chance: '{v} increase to rapid fire chance',
  vault_name_multishot_chance: 'Multishot Chance',
  vault_desc_multishot_chance: '{v} increase to multishot chance',
  vault_name_bounce_shot_chance: 'Bounce Shot Chance',
  vault_desc_bounce_shot_chance: '{v} increase to bounce shot chance',
  vault_name_defense_absolute: 'Defense Absolute',
  vault_desc_defense_absolute: '{v} increase to defense absolute',
  vault_name_health_regen: 'Health Regen',
  vault_desc_health_regen: '{v} increase to health regen',
  vault_name_health: 'Health',
  vault_desc_health: '{v} increase to health',
  vault_name_defense_percent: 'Defense %',
  vault_desc_defense_percent: '{v} increase to defense',
  vault_name_thorn_damage: 'Thorn Damage',
  vault_desc_thorn_damage: '{v} increase to thorn damage',
  vault_name_knockback_force: 'Knockback Force',
  vault_desc_knockback_force: '{v} increase to knockback force',
  vault_name_orb_speed: 'Orb Speed',
  vault_desc_orb_speed: '{v} increase to orb speed',
  vault_name_wall_rebuild: 'Wall Rebuild',
  vault_desc_wall_rebuild: '{v} to wall rebuild time',
  vault_name_knockback_chance: 'Knockback Chance',
  vault_desc_knockback_chance: '{v} increase to knockback chance',
  vault_name_shockwave_frequency: 'Shockwave Frequency',
  vault_desc_shockwave_frequency: '{v} to shockwave frequency',
  vault_name_death_defy: 'Death Defy',
  vault_desc_death_defy: '{v} increase to death defy',
  vault_name_orbs: 'Orbs',
  vault_desc_orbs: '{v} additional orb',
  vault_name_cash: 'Cash',
  vault_desc_cash: '{v} increase to cash',
  vault_name_coins_kill: 'Coins / Kill',
  vault_desc_coins_kill: '{v} increase to coins per kill',
  vault_name_enemy_attack_skip: 'Enemy Attack Skip',
  vault_desc_enemy_attack_skip: '{v} increase to enemy attack skip',
  vault_name_enemy_health_skip: 'Enemy Health Skip',
  vault_desc_enemy_health_skip: '{v} increase to enemy health skip',
  vault_name_recovery_amount: 'Recovery Amount',
  vault_desc_recovery_amount: '{v} increase to recovery amount',
  vault_name_free_attack_upgrade: 'Free Attack Upgrade',
  vault_desc_free_attack_upgrade: '{v} chance for a free attack upgrade',
  vault_name_free_defense_upgrade: 'Free Defense Upgrade',
  vault_desc_free_defense_upgrade: '{v} chance for a free defense upgrade',
  vault_name_free_utility_upgrade: 'Free Utility Upgrade',
  vault_desc_free_utility_upgrade: '{v} chance for a free utility upgrade',
  vault_name_max_recovery: 'Max Recovery',
  vault_desc_max_recovery: '{v} increase to max recovery',
  vault_name_interest_wave: 'Interest / Wave',
  vault_desc_interest_wave: '{v} increase to interest per wave',
  vault_name_cash_wave: 'Cash / Wave',
  vault_desc_cash_wave: '{v} increase to cash per wave',
  vault_name_coins_wave: 'Coins / Wave',
  vault_desc_coins_wave: '{v} increase to coins per wave',
  vault_name_tier2_unlock: 'Tier x2 Unlock',
  vault_desc_tier2_unlock: 'Unlocks the second tier of Power upgrades',
  vault_name_tier3_unlock: 'Tier x3 Unlock',
  vault_desc_tier3_unlock: 'Unlocks the third tier of Power upgrades',
  vault_name_discount_enhancements: 'Enhancements Discount',
  vault_desc_discount_enhancements: '{v} discount to enhancements',
  vault_name_discount_rerolls: 'Rerolls Discount',
  vault_desc_discount_rerolls: '{v} discount to rerolls',
  vault_name_card_slot: 'Additional Card Slot',
  vault_desc_card_slot: 'Adds a card slot',
  vault_name_free_mission_reroll: 'Free Mission Reroll',
  vault_desc_free_mission_reroll: 'Adds a free mission reroll',
  vault_name_nuke_automation: 'Nuke Automation',
  vault_desc_nuke_automation: 'Automatically uses the Nuke',
  vault_name_smart_nuke_automation: 'Smart Nuke Automation',
  vault_desc_smart_nuke_automation: 'Smartly automates the Nuke',
  vault_name_demon_mode_automation: 'Demon Mode Automation',
  vault_desc_demon_mode_automation: 'Automatically uses Demon Mode',
  vault_name_smart_demon_mode_automation: 'Smart Demon Mode Automation',
  vault_desc_smart_demon_mode_automation: 'Smartly automates Demon Mode',
  vault_name_workshop_respec_discount: 'Workshop Respec Discount',
  vault_desc_workshop_respec_discount: '{v} workshop respec discount',
  vault_name_workshop_presets: 'Workshop Presets',
  vault_desc_workshop_presets: '{v} workshop presets',
  vault_name_ad_gems_2: 'Ad Gems Stack',
  vault_desc_ad_gems_2: 'Stack ad gems up to {v}',
  vault_name_ad_gems_3: 'Ad Gems Stack',
  vault_desc_ad_gems_3: 'Stack ad gems up to {v}',
  vault_name_ad_gems_5: 'Ad Gems Stack',
  vault_desc_ad_gems_5: 'Stack ad gems up to {v}',
  vault_name_daily_mission_shard: 'Daily Mission - Set Shard Type',
  vault_desc_daily_mission_shard: 'Choose the shard type for daily missions',
  vault_name_auto_restart_run: 'Auto Restart Run',
  vault_desc_auto_restart_run: 'Automatically restarts the run',
  vault_name_bot_respec_discount: 'Bot Respec Discount',
  vault_desc_bot_respec_discount: '{v} bot respec discount',
  vault_name_bot_presets: 'Bot Presets',
  vault_desc_bot_presets: '{v} bot presets',
  vault_name_missile_barrage_automation: 'Missile Barrage Automation',
  vault_desc_missile_barrage_automation: 'Automatically uses Missile Barrage',
  vault_name_smart_missile_barrage_automation: 'Smart Missile Barrage Automation',
  vault_desc_smart_missile_barrage_automation: 'Smartly automates Missile Barrage',
  vault_name_auto_shatter_modules: 'Auto Shatter Rare Modules',
  vault_desc_auto_shatter_modules: 'Automatically shatters rare modules',
  vault_name_auto_charge_berzerker: 'Auto Charge Berzerker',
  vault_desc_auto_charge_berzerker: 'Automatically charges Berzerker',
  vault_name_damage_cap_slider: 'Damage Cap Slider',
  vault_desc_damage_cap_slider: 'Adds a damage cap slider',
  vault_name_workshop_orb_adjuster: 'Workshop Orb Adjuster',
  vault_desc_workshop_orb_adjuster: 'Adds a workshop orb adjuster',
  vault_name_bot_cooldown_sliders: 'Bot Cooldown Sliders',
  vault_desc_bot_cooldown_sliders: 'Adds bot cooldown sliders',
  ...
  guardians_chip_bits_invested_title: 'Total Bits invested in this track',
  ...
  ws_cards_rarity_common: 'Common',
  ws_cards_rarity_rare: 'Rare',
  ws_cards_rarity_epic: 'Epic',
  ws_cards_detail_close_aria: 'Close card details',
  ws_cards_detail_equip: 'Equip',
  ws_cards_detail_unequip: 'Unequip',
  ws_cards_detail_equip_aria: 'Equip {{card}}',
  ws_cards_detail_unequip_aria: 'Unequip {{card}}',
  ws_cards_detail_max_level: 'Max Level',
  ws_cards_detail_level: 'Lv. {{level}}',
  ws_cards_detail_mastery_aria: 'Card mastery',
  ...
  ws_modules_module_owned_copies_aria: '{{module}} ({{count}} copies)',
  ws_modules_inventory_copy_badge: '×{{count}}',
  ws_modules_inventory_copies_title: 'Owned copies ({{count}})',
  ws_modules_inventory_copy_line: '{{tier}} Lv. {{level}}',
  ...
  sr_reset_cards_aria: 'Reset card stars, loadouts, equip slots, and card mastery',
  sr_reset_cards_confirm_title: 'Reset cards only?',
  sr_reset_cards_confirm_body:
    'Clears card stars, all preset loadouts, equip slots, and card mastery unlocks.',

...
const HARMONY_NODES: VaultNode[] = [
  ...
  h('h-l-adgems2', 'left', 6, 'ad-gems', 'x2', 'ad_gems_2', 15, 50, 'h-m7'),
  h('h-l-adgems3', 'left', 7, 'ad-gems', 'x3', 'ad_gems_3', 20, 70, 'h-l-adgems2'),
  h('h-l-adgems5', 'left', 8, 'ad-gems', 'x5', 'ad_gems_5', 25, 95, 'h-l-adgems3'),

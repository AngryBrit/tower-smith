...
import { mergeWorkspaceBuildDomain, mergeWorkspaceLab, type TowerWorkspaceV1 } from './towerWorkspaceStorage'
import type { WorkshopPersistedV1 } from './labPresetsStorage'

type TowerWorkspaceContextValue = {
...
const TowerWorkspaceContext = createContext<TowerWorkspaceContextValue | null>(null)
...
/** @deprecated Use TowerWorkspaceProvider */
export const TowerBuildProvider = TowerWorkspaceProvider

/**
 * Builds tables/labs/perks/auto-pick-ranking.json from Tower Lab Calculator screenshot.
 * maxLevel 32; Include % off; speedup 1.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/auto-pick-ranking-rows.mjs'

/**
 * Builds tables/labs/modules/unmerge-module.json from screenshot only.
 * maxLevel 1; unlock lab; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/unmerge-module-rows.mjs'

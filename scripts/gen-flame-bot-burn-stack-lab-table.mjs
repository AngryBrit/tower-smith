/**
 * Builds tables/labs/bots/flame-bot-burn-stack.json from screenshot only.
 * maxLevel 5; Value 2 + level (max stacks); coins in T; Include % off; speedup 1.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/flame-bot-burn-stack-rows.mjs'

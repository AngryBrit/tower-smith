/**
 * Builds tables/labs/cards/energy-shield-extra-hit.json from screenshot only.
 * Calculator Value = extra hit count (1 … 2 at L1–2); Include % off.
 */
import fs from 'fs'

/**
 * Builds tables/labs/bots/amplify-bot-duration.json from screenshot only.
 * maxLevel 20; Value +0.5s × level; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/amplify-bot-duration-rows.mjs'

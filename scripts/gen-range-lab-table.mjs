/**
 * Builds tables/labs/attack/range.json from lab calculator screenshots only.
 * Sources: Range screenshots (L1–29, L28–59, L49–80).
 * Marginal time/gem/coin rows match Damage L1–80; Value column +0.02/level (1.02 … 2.60).
 */
import fs from 'fs'
...
const outPath = path.join(__dirname, '..', 'tables', 'labs', 'attack', 'range.json')

/** [value, time, gems, coins, totalTime, totalGems, totalCoins] — Range screenshots L1–80 */
const BY_LEVEL = {

/**
 * Builds tables/labs/utility/coins-kill-bonus.json from Coins / Kill Bonus calculator screenshots only.
 * Sources: Coins / Kill Bonus screenshots (L1–29, L28–59, L58–89, L68–99).
...
const outPath = path.join(__dirname, '..', 'tables', 'labs', 'utility', 'coins-kill-bonus.json')

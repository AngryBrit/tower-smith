/**
 * Builds tables/labs/bots/thunder-bot-linger-time.json from screenshot only.
 * maxLevel 20; Value +3s + 0.5s/level; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/thunder-bot-linger-time-rows.mjs'

/**
 * Builds tables/labs/modules/shatter-shards.json from screenshot only.
 * maxLevel 5; +20%/level (max +100%); T/q coins; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/shatter-shards-rows.mjs'

/**
 * Builds tables/labs/enemies/ranged-enemy-range.json from screenshot only.
 * maxLevel 30; Value -0.50%/level; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/ranged-enemy-range-rows.mjs'

/**
 * Builds tables/labs/ultimate-weapon/missiles-explosion.json from Missiles Explosion screenshot only.
 * Single unlock level (L1); benefit display is unlock copy, not numeric value.
 */
import fs from 'fs'
...
const outPath = path.join(
  ...
  'labs',
  'ultimate-weapon',
  'missiles-explosion.json',
)

/** [value, time, gems, coins, totalTime, totalGems, totalCoins] — screenshot L1 */
const BY_LEVEL = {
  1: ['1.00', '22h, 23m, 0s', '153', '900.00K', '22h, 23m, 0s', '153', '900.00K'],
}

/**
 * Builds tables/labs/ultimate-weapon/chrono-field-duration.json from Chrono Field Duration screenshot only.
 * Value 1.00/level (1.00 … 30.00); Include % off in calculator UI.
 */
import fs from 'fs'
...
const BY_LEVEL = {
  ...
  21: ['21.00', '32 days, 14h, 19m, 0s', '3.74K', '3.93B', '190 days, 9h, 38m, 0s', '24.17K', '16.87B'],
  22: ['22.00', '38 days, 3h, 12m, 0s', '4.15K', '4.85B', '228 days, 12h, 50m, 0s', '28.32K', '21.72B'],
  23: ['23.00', '44 days, 8h, 27m, 0s', '4.62K', '5.92B', '272 days, 21h, 17m, 0s', '32.94K', '27.64B'],
  24: ['24.00', '51 days, 7h, 16m, 0s', '5.13K', '7.17B', '324 days, 4h, 33m, 0s', '38.07K', '34.81B'],
  25: ['25.00', '59 days, 50m, 0s', '5.70K', '8.61B', '1 year, 18 days, 5h, 23m, 0s', '43.77K', '43.42B'],
  26: ['26.00', '67 days, 14h, 25m, 0s', '6.34K', '10.26B', '1 year, 85 days, 19h, 48m, 0s', '50.11K', '53.68B'],
  27: ['27.00', '77 days, 1h, 17m, 0s', '7.04K', '12.15B', '1 year, 162 days, 21h, 5m, 0s', '57.15K', '65.83B'],
  28: ['28.00', '87 days, 10h, 41m, 0s', '7.81K', '14.29B', '1 year, 250 days, 7h, 46m, 0s', '64.96K', '80.12B'],
  29: ['29.00', '98 days, 19h, 58m, 0s', '8.56K', '16.70B', '1 year, 349 days, 3h, 44m, 0s', '73.52K', '96.82B'],
  30: ['30.00', '111 days, 6h, 28m, 0s', '9.34K', '19.42B', '2 years, 95 days, 10h, 12m, 0s', '82.86K', '116.24B'],
}

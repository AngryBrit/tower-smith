/**
 * Builds tables/labs/enemies/fast-enemy-speed.json from screenshot only.
 * maxLevel 30; Value -0.40%/level; 60B coin curve; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/fast-enemy-speed-rows.mjs'

/**
 * Builds tables/labs/utility/cash-wave.json from Cash / Wave calculator screenshots only.
 * Sources: Cash / Wave screenshots (L1–29, L28–59, L58–89, L68–99).
...
const outPath = path.join(__dirname, '..', 'tables', 'labs', 'utility', 'cash-wave.json')

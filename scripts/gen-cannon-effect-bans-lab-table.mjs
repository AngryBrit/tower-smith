/**
 * Builds tables/labs/modules/cannon-effect-bans.json from screenshot only.
 * maxLevel 4; ban count 1–4; Armor Effect Bans aliases here in labCosts.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/cannon-effect-bans-rows.mjs'

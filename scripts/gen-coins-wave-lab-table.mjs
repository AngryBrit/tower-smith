/**
 * Builds tables/labs/utility/coins-wave.json from Coins / Wave calculator screenshots only.
 * Sources: Coins / Wave screenshots (L1–29, L28–59, L58–89, L68–99).
...
const outPath = path.join(__dirname, '..', 'tables', 'labs', 'utility', 'coins-wave.json')

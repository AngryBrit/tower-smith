/**
 * Builds tables/labs/enemies/boss-enemy-health.json from screenshot only.
 * maxLevel 30; Value -0.30%/level (max -9.00%); 40B coin curve; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/boss-enemy-health-rows.mjs'

/**
 * Builds tables/labs/ultimate-weapon/chain-lightning-shock.json from screenshot only.
...
const outPath = path.join(
  ...
  'labs',
  'ultimate-weapon',
  'chain-lightning-shock.json',
)

/** [value, time, gems, coins, totalTime, totalGems, totalCoins] — screenshot L1 */
const BY_LEVEL = {
  1: ['1.00', '23h, 53m, 0s', '163', '950.00K', '23h, 53m, 0s', '163', '950.00K'],
}

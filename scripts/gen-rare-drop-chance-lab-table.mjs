/**
 * Builds tables/labs/modules/rare-drop-chance.json from screenshot only.
 * maxLevel 10; +0.10%/level (max +1.00%); 70B coin curve; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/rare-drop-chance-rows.mjs'

/**
 * Builds tables/labs/modules/assist-module-substats-cannon.json from screenshot only.
 * maxLevel 30; Value n% per level; speedup 1; Include % off.
 * Other Assist Module Substats/Bonus labs alias here in labCosts.ts
 * (Armor/Generator/Core Substats + all Bonus variants share this ladder).
 */
...
const outPath = path.join(
  ...
  'labs',
  'modules',
  'assist-module-substats-cannon.json',
)

/** Assist calculator: lowercase q = 1e12 (250.00q), uppercase Q = 1e15 (1.00Q). */

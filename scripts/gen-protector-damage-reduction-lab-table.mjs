/**
 * Builds tables/labs/enemies/protector-damage-reduction.json from screenshot only.
 * maxLevel 20; Value -0.30%/level (max -6.00%); 80B coin curve; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/protector-damage-reduction-rows.mjs'
...
const outPath = path.join(
  ...
  'labs',
  'enemies',
  'protector-damage-reduction.json',
)

/**
 * Builds tables/labs/cards/super-tower-bonus.json from lab calculator screenshot only.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/super-tower-bonus-rows.mjs'

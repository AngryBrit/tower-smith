/**
 * Builds tables/labs/perks/waves-required.json from Tower Lab Calculator screenshots.
 * Dropdown: Waves Required; speedup 1; Include % checked (as shown).
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/waves-required-rows.mjs'

/**
 * Builds tables/labs/ultimate-weapon/chrono-field-damage-reduction.json from screenshot only.
...
const outPath = path.join(
  ...
  'labs',
  'ultimate-weapon',
  'chrono-field-damage-reduction.json',
)

/** [value, time, gems, coins, totalTime, totalGems, totalCoins] — screenshot L1 */
const BY_LEVEL = {
  1: ['1.00', '16h, 39m, 0s', '114', '750.00K', '16h, 39m, 0s', '114', '750.00K'],
}

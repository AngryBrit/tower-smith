/**
 * Builds tables/labs/modules/core-effect-bans.json from screenshot only.
 * maxLevel 7; ban count 1–7; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/core-effect-bans-rows.mjs'

/**
 * Builds tables/labs/attack/light-speed-shots.json from lab calculator screenshot only.
 */
import fs from 'fs'
...
const outPath = path.join(
  ...
  'labs',
  'attack',
  'light-speed-shots.json',
)

/** [value, time, gems, coins, totalTime, totalGems, totalCoins] — screenshot L1 */
const BY_LEVEL = {
  1: ['1.00', '19h, 59m, 0s', '136', '3.00M', '19h, 59m, 0s', '136', '3.00M'],
}
...
const levels = []
for (const [levelStr, row] of Object.entries(BY_LEVEL)) {

/**
 * Builds tables/labs/modules/daily-mission-shards.json from screenshot only.
 * maxLevel 50; +1 shard/level; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/daily-mission-shards-rows.mjs'

/**
 * Builds tables/labs/modules/generator-effect-bans.json from screenshot only.
 * maxLevel 3; ban count 1–3; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/generator-effect-bans-rows.mjs'

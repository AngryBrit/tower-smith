/**
 * Builds tables/labs/cards/recharge-nuke.json from screenshot only.
...
const BY_LEVEL = {
  1: ['1500.00', '5 days, 5h, 0m, 0s', '751', '550.00B', '5 days, 5h, 0m, 0s', '751', '550.00B'],
  2: ['1250.00', '6 days, 14h, 21m, 9s', '944', '1.05T', '11 days, 19h, 21m, 9s', '1.70K', '1.60T'],
  3: ['1000.00', '8 days, 54m, 39s', '1.12K', '1.55T', '19 days, 20h, 15m, 48s', '2.81K', '3.15T'],
  4: ['750.00', '9 days, 23h, 10m, 29s', '1.33K', '2.05T', '29 days, 19h, 26m, 17s', '4.14K', '5.20T'],
  5: ['550.00', '14 days, 1h, 58m, 39s', '1.79K', '2.56T', '43 days, 21h, 24m, 56s', '5.93K', '7.76T'],
  6: ['400.00', '24 days, 19h, 29m, 9s', '2.98K', '3.07T', '68 days, 16h, 54m, 5s', '8.90K', '10.83T'],
  7: ['300.00', '51 days, 8h, 12m, 0s', '5.13K', '3.60T', '120 days, 1h, 6m, 5s', '14.03K', '14.43T'],
}

 ...
 * Builds tables/labs/ultimate-weapon/inner-land-mine-chrono-jump.json from screenshot only.

 * Calculator Value 5s × level (5 … 50 at L1–10); coins in q/Q; Include % off.
...
const outPath = path.join(
  ...
  'inner-land-mine-chrono-jump.json',

/**
 * Builds tables/labs/modules/armor-effect-bans.json from screenshot only.
 * maxLevel 4; ban count 1–4; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/armor-effect-bans-rows.mjs'

/**
 * Builds tables/labs/card-mastery/berserker-mastery.json from screenshot only.
 * Calculator Value 60.00 + 30.00/level (60.00 … 300.00 at L1–9); coins in q; Include % off.
 */
...
const outPath = path.join(
  ...
  'labs',
  'card-mastery',
  'berserker-mastery.json',
)

/** [value, time, gems, coins, totalTime, totalGems, totalCoins] — screenshot L1–9 */
const BY_LEVEL = {
  1: ['60.00', '20 days, 20h, 0m, 0s', '2.53K', '1.10q', '20 days, 20h, 0m, 0s', '2.53K', '1.10q'],
  2: ['90.00', '31 days, 6h, 0m, 0s', '3.64K', '1.30q', '52 days, 2h, 0m, 0s', '6.18K', '2.40q'],
  3: ['120.00', '41 days, 16h, 0m, 0s', '4.42K', '2.00q', '93 days, 18h, 0m, 0s', '10.59K', '4.40q'],
  4: ['150.00', '52 days, 2h, 0m, 0s', '5.19K', '3.40q', '145 days, 20h, 0m, 0s', '15.78K', '7.80q'],
  5: ['180.00', '62 days, 12h, 0m, 0s', '5.96K', '5.60q', '208 days, 8h, 0m, 0s', '21.74K', '13.40q'],
  6: ['210.00', '72 days, 22h, 0m, 0s', '6.73K', '7.70q', '281 days, 6h, 0m, 0s', '28.48K', '21.10q'],
  7: ['240.00', '83 days, 8h, 0m, 0s', '7.51K', '9.10q', '364 days, 14h, 0m, 0s', '35.98K', '30.20q'],
  8: ['270.00', '93 days, 18h, 0m, 0s', '8.24K', '9.80q', '1 year, 93 days, 8h, 0m, 0s', '44.22K', '40.00q'],
  9: ['300.00', '104 days, 4h, 0m, 0s', '8.89K', '10.00q', '1 year, 197 days, 12h, 0m, 0s', '53.11K', '50.00q'],
}

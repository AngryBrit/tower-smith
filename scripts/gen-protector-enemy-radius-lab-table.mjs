/**
 * Builds tables/labs/enemies/protector-enemy-radius.json from screenshot only.
 * maxLevel 30; Value -0.30%/level; 40B coin curve; speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/protector-enemy-radius-rows.mjs'

/**
 * Builds tables/labs/attack/attack-speed.json from lab calculator screenshots only.
 * Sources: Attack Speed screenshots (L1–29, L28–59, L58–89, L68–99).
 * Marginal time/gem/coin rows match Damage L1–99 in the calculator (shared attack ladder).
 */
import fs from 'fs'
...
const damagePath = path.join(__dirname, '..', 'tables', 'labs', 'attack', 'damage.json')
const outPath = path.join(__dirname, '..', 'tables', 'labs', 'attack', 'attack-speed.json')

/** [value, time, gems, coins, totalTime, totalGems, totalCoins] — Attack Speed screenshots L1–99 */
const BY_LEVEL = {

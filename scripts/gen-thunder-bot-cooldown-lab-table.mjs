/**
 * Builds tables/labs/bots/thunder-bot-cooldown.json from screenshot only.
 * maxLevel 25; Value −1 × level; Include % off; speedup 1.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/thunder-bot-cooldown-rows.mjs'

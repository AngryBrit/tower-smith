/**
 * Builds tables/labs/modules/module-shards-cost.json from screenshot only.
 * maxLevel 30; −1%/level (max −30%); speedup 1; Include % off.
 */

import fs from 'fs'
import path from 'path'
import { fileURLToPath } from 'url'
import { ROWS } from './data/module-shards-cost-rows.mjs'

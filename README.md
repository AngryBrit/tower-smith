...
![Version](https://img.shields.io/badge/version-2.8.8-2ea44f)
...
- **Relics** — **Relics** tab tracks **264** wiki relics with in-game WebP art on each card (owned IDs, unlock-group filters, bonus breakdown) and optional displayed-damage bonus for workshop sim formulas. **Search** filters by name, description, or unlock text (`/` to focus).
...
| [`gen-relic-images.mjs`](scripts/gen-relic-images.mjs) | Match `public/relics/*.webp` to catalog ids and regenerate [`workshopRelicImages.generated.json`](src/data/workshopRelicImages.generated.json). |
...
| [`public/relics/`](public/relics/) | Relic WebP art keyed by catalog id via [`workshopRelicImages.generated.json`](src/data/workshopRelicImages.generated.json). |

...
- **Relics** — **Relics** tab tracks **262** wiki relics with in-game WebP art on each card (owned IDs, unlock-group filters, bonus breakdown) and optional displayed-damage bonus for workshop sim formulas. **Search** filters by name, description, or unlock text (`/` to focus).
